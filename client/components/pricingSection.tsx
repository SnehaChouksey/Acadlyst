        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="relative h-full p-8 rounded-3xl bg-card/90 backdrop-blur-xl border border-transparent shadow-2xl">
              ...
              <div className="mb-8">
                <span className="text-4xl font-bold bg-linear-to-r from-[#E23B6D] to-[#FF7CA3] bg-clip-text text-transparent">
                  $2
                </span>
                <span className="text-muted-foreground ml-2">/ month</span>
              </div>
              ...
              <Button
                ...
                className="
                  w-full h-12 rounded-xl bg-linear-to-r from-[#E23B6D] to-[#FF7CA3]
                  text-white font-semibold shadow-lg
                  transition-all duration-150
                  hover:from-[#ff1165] hover:to-[#ff5183] hover:-translate-y-0.5 hover:shadow-xl
                  disabled:opacity-80 disabled:cursor-not-allowed disabled:hover:translate-y-0
                "
              >
                {isSubscribing && (
                  <span
                    className="inline-block h-4 w-4 mr-2 border-2 border-white/70 border-t-transparent rounded-full animate-spin"
                    aria-hidden="true"
                  />
                )}
                <span>
